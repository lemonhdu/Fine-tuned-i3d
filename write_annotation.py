...
split = "4"
split_dir = r"/disks/disk0/huang/dataset/segmentation/50salads/splits"
annotation_dir = r"/disks/disk0/huang/dataset/segmentation/50salads/groundTruth"
video_fps = 15.0
...
for i, item in enumerate(training_video_list):
    ...
    action_arr = []
    # set pre_action variation to the label of the first frame
    pre_action = 0
    pre_transtime = 0.0
